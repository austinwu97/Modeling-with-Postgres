...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time varchar, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar)")
...
artist_table_create = ("CREATE TABLE IF NOT EXISTS artists (artist_id varchar, name varchar, location varchar, latitute varchar, longitude varchar)")
...
artist_table_insert = "INSERT INTO artists (artist_id, name, location, latitute, longitude) VALUES (%s, %s, %s, %s, %s)"
